...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training and friendly matches on the field",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice drills and pickup games for basketball enthusiasts",
    ...
    "Drama Club": {
        "description": "Rehearse scenes, improvise, and prepare school performances",
    ...
    "Science Quiz Club": {
        "description": "Study science topics and practice for academic quiz competitions",
